...
class verificationOTPCode extends StatefulWidget {
  const verificationOTPCode({Key? key}) : super(key: key);

  @override
  _verificationOTPCodeState createState() => _verificationOTPCodeState();
}
                      ...
                      child: Row(
                        children: [
                          ...
                          Container(
                            ...
                            child: Icon(Iconsax.repeat, size: 20, color: black1)
                          )
                        ],
                      )
                  ),
